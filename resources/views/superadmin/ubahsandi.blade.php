@extends('layouts.app')
@section('title', 'SuperAdmin ubah sandi - SMK Hijau Muda')
...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white shadow-sm rounded-lg p-6">
            ...
            <form action="{{ route('superadmin.password.change') }}" method="POST">
                @csrf
    ...
    <div class="flex justify-end">
        <a href="{{ route('superadmin.settings.index') }}" class="text-gray-600 hover:underline mr-150 mt-2">← Kembali</a>
