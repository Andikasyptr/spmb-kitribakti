@extends('layouts.app')
@section('title', 'Guru Ubah Sandi - smkhijaumuda')
...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white shadow-sm rounded-lg p-6">
            ...
            <form action="{{ route('guru.ubahsandi.update') }}" method="POST">
                @csrf
                @method('PUT')
               ...
               <div class="flex justify-end gap-4 items-center mt-8">
                <a href="{{ route('guru.settings') }}" class="text-gray-600 hover:underline">← Kembali</a>
