...
<div class="py-6">
    <div class="max-w-4xl mx-auto bg-white p-6 rounded shadow">
        <h2 class="text-2xl font-bold mb-6">Detail Siswa Keluar</h2>
        ...
        <table class="w-full table-auto text-sm">
            <tbody class="divide-y divide-gray-200">
                ...
                <tr><td class="font-semibold py-2">Pekerjaan Ayah</td><td class="py-2">{{ $siswa->pekerjaan_ayah ?? '-' }}</td></tr>
                <tr><td class="font-semibold py-2">Penghasilan Ayah</td><td class="py-2">{{ $siswa->penghasilan_ayah ?? '-' }}</td></tr>
                <tr><td class="font-semibold py-2">NIK Ibu</td><td class="py-2">{{ $siswa->nik_ibu ?? '-' }}</td></tr>
                <tr><td class="font-semibold py-2">Pendidikan Terakhir Ibu</td><td class="py-2">{{ $siswa->pendidikan_ibu ?? '-' }}</td></tr>
                <tr><td class="font-semibold py-2">Pekerjaan Ibu</td><td class="py-2">{{ $siswa->pekerjaan_ibu ?? '-' }}</td></tr>
                <tr><td class="font-semibold py-2">Penghasilan Ibu</td><td class="py-2">{{ $siswa->penghasilan_ibu ?? '-' }}</td></tr>
        ...
        <div class="mt-6">
            <a href="{{ route('datasiswa.move') }}" class="inline-block bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600">Kembali</a>
        </div>
    </div>
</div>
@endsection
