@extends('layouts.app')
@section('title', 'Admin Edit Profile - smkhijaumuda')
...
<div class="max-w-4xl mx-auto py-6">
    ...
    <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded shadow">
        @csrf
        @method('PUT')
