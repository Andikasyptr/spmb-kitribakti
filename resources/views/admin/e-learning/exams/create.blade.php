...
<div class="p-4 sm:p-6 bg-white rounded-lg shadow max-w-lg mx-auto">
    ...
    <form action="{{ route('admin.exams.store') }}" method="POST" class="space-y-5" id="formExam">
        @csrf
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Update hidden title setiap kali mapel dipilih
        ...
        // Pastikan hidden title terisi saat submit
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Update hidden title dan deskripsi otomatis saat mapel dipilih
    selectMapel.addEventListener('change', function() {
        const selectedOption = this.options[this.selectedIndex];
        titleInput.value = selectedOption.getAttribute('data-nama') || '';
        descInput.value = selectedOption.getAttribute('data-deskripsi') || '';
